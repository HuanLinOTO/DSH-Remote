...
const STORAGE_KEY_WAKE_LOCK = 'dsh-wake-lock'
const STORAGE_KEY_SIDEBAR = 'dsh-sidebar-expanded'
const STORAGE_KEY_SIDEBAR_FOLDER_RECENTS = 'dsh-sidebar-folder-recents'
const STORAGE_KEY_SIDEBAR_FOLDER_RECENTS_SHOW_DIFF = 'dsh-sidebar-folder-recents-show-diff'
const STORAGE_KEY_SIDEBAR_SHOW_CHILD_SESSIONS = 'dsh-sidebar-show-child-sessions'
const STORAGE_KEY_PANEL_LAYOUT = 'dsh-panel-layout'
const STORAGE_KEY_TERMINAL_LAYOUT = 'dsh-terminal-layout'
const STORAGE_KEY_RIGHT_PANEL_WIDTH = 'dsh-right-panel-width'
const STORAGE_KEY_BOTTOM_PANEL_HEIGHT = 'dsh-bottom-panel-height'
const STORAGE_KEY_VIEWPORT_SIDEBAR_WIDTH = 'sidebar-width'
const STORAGE_KEY_TERMINAL_COPY_ON_SELECT = 'dsh-terminal-copy-on-select'
const STORAGE_KEY_TERMINAL_RIGHT_CLICK_PASTE = 'dsh-terminal-right-click-paste'
...
export class LayoutStore {
  ...
  setBottomPanelHeight(height: number) {
    this.state.bottomPanelHeight = height
    try {
      localStorage.setItem(STORAGE_KEY_BOTTOM_PANEL_HEIGHT, height.toString())
    } catch {
      // ignore
    }
    this.notify()
