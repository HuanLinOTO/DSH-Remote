    ...
    <div>
      ...
      <SettingsSection title={t('chat.conversationExperience')} description={t('chat.conversationExperienceDesc')}>
        ...
        <SettingRow
          ...
          onClick={() => setProcessCollapseEnabled(!processCollapseEnabled)}
        >
          <Toggle enabled={processCollapseEnabled} onChange={() => setProcessCollapseEnabled(!processCollapseEnabled)} />
        </SettingRow>
