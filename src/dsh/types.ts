// DSH Remote domain types — ported from ds-harness-remote apps/android/src/types.ts
// (web adaptation: no React Native / Expo specific fields, no i18n-coupled helpers)

import type { TransportStats } from './vendor/protocol'
...
/** 登录方式中需要浏览器重定向回跳的一类（对齐原 RedirectLoginMethod）。 */
export type OAuthRedirectMethod = Extract<LoginMethod, 'oauth' | 'github-oauth'>
